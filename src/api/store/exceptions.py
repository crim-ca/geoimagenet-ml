...
class DatasetNotFoundError(Exception):
    ...
    storage backend by an instance of :class:`src.api.store.interfaces.DatasetStore`.
    """
    pass
...
class DatasetConflictError(Exception):
    """
    Error indicating that the instance of :class:`src.api.store.interfaces.DatasetStore`
...
class ModelNotFoundError(Exception):
    ...
    storage backend by an instance of :class:`src.api.store.interfaces.ModelStore`.
    """
    pass
...
class ModelConflictError(Exception):
    """
    Error indicating that the instance of :class:`src.api.store.interfaces.ModelStore`
    is conflicting with another process in the storage backend .
    """
    pass
...
class ProcessNotFoundError(Exception):
    ...
    storage backend by an instance of :class:`src.api.store.interfaces.ProcessStore`.
    """
    pass
...
class ProcessConflictError(Exception):
    """
    Error indicating that the instance of :class:`src.api.store.interfaces.ProcessStore`
    is conflicting with another process in the storage backend .
    """
    pass
...
class JobNotFoundError(Exception):
    ...
    storage backend by an instance of :class:`src.api.store.interfaces.JobStore`.
    """
    pass
...
class JobConflictError(Exception):
    """
    Error indicating that the instance of :class:`src.api.store.interfaces.JobStore`
    is conflicting with another process in the storage backend .
    """
    pass
