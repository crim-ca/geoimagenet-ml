...
from ccfb.api.store.datatypes import Dataset, Model, Process, Job
from ccfb.api.store.interfaces import DatasetStore, ModelStore, ProcessStore, JobStore
from ccfb.api.utils import islambda, get_sane_name
...
class MongodbProcessStore(ProcessStore, MongodbStore):
    ...
    def __init__(self, collection, settings, default_processes=None):
        from ccfb.api.rest_api.schemas import ProcessJobsAPI
