...
from ccfb.api.processes.status import job_status_values
import six
import colander
...
class BaseMetaResponseSchema(colander.MappingSchema):
    code = colander.SchemaNode(
        colander.Integer(), description="HTTP response code.", example=p.HTTPOk.code)
...
class BaseResponseSchema(colander.MappingSchema):
    ...
    header = AcceptHeader()
    body = BaseBodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class UnauthorizedResponseSchema(BaseResponseSchema):
    ...
    body = ErrorBodyResponseSchema(code=p.HTTPUnauthorized.code, description=description)


class NotFoundResponseSchema(BaseResponseSchema):
    description = "The route resource could not be found."
    body = ErrorBodyResponseSchema(code=p.HTTPNotFound.code, description=description)


class UnprocessableEntityResponseSchema(BaseResponseSchema):
    description = "Invalid value specified."
    body = ErrorBodyResponseSchema(code=p.HTTPUnprocessableEntity.code, description=description)
...
class InternalServerErrorBodySchema(ErrorBodyResponseSchema):
    def __init__(self, description):
        super(InternalServerErrorBodySchema, self).\
            __init__(code=p.HTTPInternalServerError.code, description=description)
...
class Datasets_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = Datasets_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)


class Datasets_GET_ForbiddenResponseSchema(BaseResponseSchema):
    description = "Get datasets by name query refused by db."
    body = ErrorBodyResponseSchema(code=p.HTTPForbidden.code, description=description)
...
class Datasets_POST_CreatedResponseSchema(BaseResponseSchema):
    ...
    body = Datasets_POST_BodyResponseSchema(code=p.HTTPCreated.code, description=description)


class Datasets_POST_BadRequestResponseSchema(BaseResponseSchema):
    description = "Invalid parameter specified to create dataset."
    body = ErrorBodyResponseSchema(code=p.HTTPBadRequest.code, description=description)
...
class Datasets_POST_ConflictResponseSchema(BaseResponseSchema):
    ...
    body = ErrorBodyResponseSchema(code=p.HTTPConflict.code, description=description)
...
class Dataset_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = Dataset_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class Models_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = Models_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class Models_POST_CreatedResponseSchema(BaseResponseSchema):
    ...
    body = Models_POST_BodyResponseSchema(code=p.HTTPCreated.code, description=description)
...
class Model_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = Model_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class Processes_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = Processes_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class Processes_POST_CreatedResponseSchema(BaseResponseSchema):
    ...
    body = Processes_POST_BodyResponseSchema(code=p.HTTPCreated.code, description=description)
...
class Process_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = Process_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class ProcessJob_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = ProcessJob_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class ProcessJobLogs_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = ProcessJobLogs_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class ProcessJobExceptions_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = ProcessJobExceptions_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class Base_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = Base_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
...
class Versions_GET_OkResponseSchema(BaseResponseSchema):
    ...
    body = Versions_GET_BodyResponseSchema(code=p.HTTPOk.code, description=description)
