#!/usr/bin/env python
# coding: utf-8
from ccfb.api.rest_api import schemas as s, generic as g
import logging
logger = logging.getLogger(__name__)


def includeme(config):
    logger.info('Adding rest_api ...')
    config.include('src.api.rest_api.datasets')
    config.include('src.api.rest_api.models')
    config.include('src.api.rest_api.processes')
